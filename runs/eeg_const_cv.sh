...
--metrics_dir ../mcmc_vr/sgmcmc/eeg/metrics \
--prefix_name sghmc \
--model_config_path ../mcmc_vr/sgmcmc/eeg/sghmc_train_var100_config.json \
--train_trajs_path ../mcmc_vr/sgmcmc/eeg/sghmc_train_var100_traj.pkl \
--test_trajs_path ../mcmc_vr/sgmcmc/eeg/sghmc_test_var100_traj.pkl \
--dataset uci \
--seed 42 \
--cv_dir ../mcmc_vr/sgmcmc/eeg
#--cv_path ../mcmc_vr/sgmcmc/eeg/svrg_ld_5traj_const_psy.pt
...
--figs_dir ../mcmc_vr/sgmcmc/eeg/figs \
--metrics_dir ../mcmc_vr/sgmcmc/eeg/metrics \
--prefix_name svrg_hmc \
--model_config_path ../mcmc_vr/sgmcmc/eeg/svrg_hmc_train_var100_config.json \
--train_trajs_path ../mcmc_vr/sgmcmc/eeg/svrg_hmc_train_var100_traj.pkl \
--test_trajs_path ../mcmc_vr/sgmcmc/eeg/svrg_hmc_test_var100_traj.pkl \
--dataset uci \
--seed 42 \
--cv_dir ../mcmc_vr/sgmcmc/eeg
#--cv_path ../mcmc_vr/sgmcmc/eeg/svrg_ld_5traj_const_psy.pt