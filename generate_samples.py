...
def sample_trajectory():
    if args.n_hidden_layers == 0:
        ...
        model = MLP(input_dim=INPUT_DIM, width=args.hidden_dim, depth=args.n_hidden_layers,
                    output_dim=len(args.classes))
    ...
    trainer.train(n_epoch=args.n_epoch, burn_in_epochs=args.burn_in_epochs,
